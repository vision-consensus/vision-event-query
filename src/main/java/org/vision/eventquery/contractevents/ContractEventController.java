package org.vision.eventquery.contractevents;


import static org.vision.common.utils.LogConfig.LOG;
import static org.vision.core.Wallet.decode58Check;
...
import org.vision.common.crypto.Crypto;
import org.vision.common.utils.ByteArray;
import org.vision.eventquery.query.QueryFactory;
import org.vision.eventquery.response.Response;
import org.vision.eventquery.solidityevents.SolidityTriggerEntity;
...
public class ContractEventController {
  ...
  public List<JSONObject> findOneByTransactionVisionGri (@PathVariable String transactionId) {
  ...
  public Object findEventsByContractAddressVisionGrid (
      @PathVariable String contractAddress,
  ...
  public Object findEventsByContractAddressAndEventNameVisionGrid (
      @PathVariable String contractAddress,
      @PathVariable String eventName,
      @RequestParam(value = "size", required = false, defaultValue = "20") int limit,
      @RequestParam(value = "sort", required = false, defaultValue = "-timeStamp") String sort,
  ...
  public List<JSONObject> findEventsByContractAddressAndEventNameAndBlockNumVisionGrid (
      @PathVariable String contractAddress,
      @PathVariable String eventName,
